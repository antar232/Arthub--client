  ...
  return (
    <section className="py-12 px-6 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-end mb-8">
        <div>
          <h2 className="text-3xl font-bold text-black">Featured Artworks</h2>
          <p className="text-gray-800 mt-1">
            Handpicked originals from our community
          </p>
        </div>
        <Link
          href="/browse"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {artworks.map((art) => (
          // Link টি প্রতিটি কার্ডের ভেতরে নিয়ে আসুন
          <Link href={`/details/${art._id}`} key={art._id} className="block">
            <div className="bg-[#1f2533] rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-violet-900/20 transition-all border border-white/5">
              {/* Image */}
