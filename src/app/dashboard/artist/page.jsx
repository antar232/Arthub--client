...
import { Briefcase, Envelope, Person, Plus, ChartColumn, ListUl, Gear } from "@gravity-ui/icons";
...
const ArtistDashboard = () => {
    ...
    const recentSales = [
        { id: 101, title: "Abstract Sunset", buyer: "John Doe", price: "$450", date: "18 Jun, 2026" },
        { id: 102, title: "Ocean Waves", buyer: "Sarah Smith", price: "$300", date: "15 Jun, 2026" },
        { id: 103, title: "Urban Dreams", buyer: "Mike Johnson", price: "$800", date: "10 Jun, 2026" },
        { id: 104, title: "Neon City", buyer: "Alice Brown", price: "$550", date: "05 Jun, 2026" },
    ];
        ...
        <div className="flex flex-col gap-8 w-full max-w-7xl mx-auto text-white-600 p-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="text-white-600">
                    Welcome back! Manage your gallery, track sales, and update your profile from here.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-[#18181d] border border-neutral-800 rounded-2xl p-6 flex flex-col">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h3 className="text-lg text-neutral-400 font-semibold">Recent Sales</h3>
                            <p className="text-sm text-neutral-400">Your latest artwork purchases</p>
                        </div>
                        <Link href="/dashboard/artist/sales" className="text-sm text-blue-400 hover:text-blue-300 font-medium">
                            View Full History
                        </Link>
                    </div>
                            ...
                            <tbody className="divide-y divide-white-800">
                                {recentSales.map((sale) => (
                                    <tr key={sale.id} className="hover:bg-neutral-900/50 transition-colors">
                                        <td className="py-4 text-neutral-400 font-medium">{sale.title}</td>
                                        <td className="py-4 text-neutral-400">{sale.buyer}</td>
                                        <td className="py-4 text-neutral-400">{sale.date}</td>
                                        <td className="py-4 font-semibold text-right text-green-400">{sale.price}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                ...
                <div className="bg-[#18181b] border border-neutral-800 rounded-2xl p-6 flex flex-col gap-6">
                    <div>
                        ...
                        <p className="text-sm text-neutral-400">Quick access to your tools</p>
                    </div>
                    
                    <div className="flex flex-col gap-3">
                        {/* 1. Add Artwork */}
                        <Link href="/dashboard/artist/artworks/new" className="w-full block">
                            <Button 
