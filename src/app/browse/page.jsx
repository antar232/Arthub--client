  ...
  if (loading)
    return (
      <div className="flex justify-center p-20">
        <Loader2 className="animate-spin size-10 text-orange-600" />
      </div>
    );
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 bg-white min-h-screen">
      ...
      <p className="text-gray-600 mb-8">
        Explore original art from independent artists
      </p>
            ...
            <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center mt-4">
                  ...
                  <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-[12px] font-medium uppercase tracking-wider">
                    {art.category}
                  </span>
                </div>
              </div>
